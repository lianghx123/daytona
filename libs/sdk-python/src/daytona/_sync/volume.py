...
from daytona_api_client import CreateVolume, CreateVolumeBackendDto, VolumesApi
...
class VolumeService:
    ...
    @with_instrumentation()
    def create(self, name: str, backend: CreateVolumeBackendDto | None = None) -> Volume:
        """Create a new Volume.
        ...
        Example:
            ...
            ```
        """
        return Volume.from_dto(self.__volumes_api.create_volume(CreateVolume(name=name, backend=backend)))
